...
Messina G, Polito R, Monda V, Cipolloni L, Di Nunno N, Di Mizio G, Murabito P, Carotenuto M, Messina A, Pisanelli D, Valenzano A, Cibelli G, Scarinci A, Monda M, Sessa F. Functional Role of Dietary Intervention to Improve the Outcome of COVID-19: A Hypothesis of Work. International Journal of Molecular Sciences. 2020; 21(9):3104. https://doi.org/10.3390/ijms21093104

Onishi J. C., Häggblom M. M., Shapses S. A., et al. Can Dietary Fatty Acids Affect the COVID-19 Infection Outcome in Vulnerable Populations? mBio. 11(4):e01723-20. doi:10.1128/mBio.01723-20
...
food %>%
  group_by(income) %>%
  summarize(count = n()) %>%
  ggplot(aes(x = income, y = count)) + geom_col()
```
