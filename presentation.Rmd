...
- This model has a slightly larger adjusted r squared value, (5.05% compared to 6%) indicating that it accounts for slightly more variance in the data than the first model that did not include income
