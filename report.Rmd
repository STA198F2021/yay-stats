...
```{r graphs_of_deviation_vs_recovery rate, message=FALSE, echo = FALSE, warning=FALSE}
food %>% 
...
```
This graph also indicates that the model that includes income as well as dietary deviation is a better predictor of covid outcomes than a model that solely relies on dietary deviation. The residuals are more evenly spread along 0. 
